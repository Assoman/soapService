...
class TemperatureConversionsTest {
    ...
    void getTemperatureConversionsSoap1() {
        TemperatureConversionsSoapType service = new TemperatureConversions().getTemperatureConversionsSoap();
        BigDecimal result = service.windChillInCelsius(BigDecimal.valueOf(0), BigDecimal.valueOf(35));
        assertEquals(BigDecimal.valueOf(-24.07), result);
    }
    ...
    void getTemperatureConversionsSoap121() {
        TemperatureConversionsSoapType service = new TemperatureConversions().getTemperatureConversionsSoap12();
        BigDecimal result = service.windChillInFahrenheit(BigDecimal.valueOf(32), BigDecimal.valueOf(35));
        assertEquals(BigDecimal.valueOf(-11.326), result);
    }
}